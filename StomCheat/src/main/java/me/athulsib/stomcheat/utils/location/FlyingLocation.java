package me.athulsib.stomcheat.utils.location;

import me.athulsib.stomcheat.utils.Vector3d;
...
public class FlyingLocation {
    ...
    public FlyingLocation(Instance world, int tick, double posX, double posY, double posZ) {
        this.world = world;
        this.tick = tick;
        this.posX = posX;
        this.posY = posY;
    ...
    public FlyingLocation(Instance world, int tick, double posX, double posY, double posZ, float yaw, float pitch,
                          boolean onGround) {
        this.world = world;
        this.tick = tick;
        this.posX = posX;
    ...
    public Pos toPos() {
        return new Pos(this.posX, this.posY, this.posZ, this.yaw, this.pitch);
    }
    ...
    public boolean isSameRotation(FlyingLocation o) {
